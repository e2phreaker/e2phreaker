...
# =========================
VERSION="1.0"
REPO="https://raw.githubusercontent.com/e2phreaker/e2phreaker/main"
...
while true; do
    ...
    case $menu in
        ...
        4)
            clear
            bash "$WORKDIR/prompt-aio-loop.sh"
    ;;
            ;;
        9)
            check_update
